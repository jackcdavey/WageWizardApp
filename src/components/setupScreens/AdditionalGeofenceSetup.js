...
export default function AdditionalGeofenceSetup({ route, navigation }) {
    /* 2. Get the param */
            ...
            if (realm) {
                realm.write(() => {
                    newGeofence = realm.create('GeofenceLocation', {
                        //Add geofence count property to job perhaps?
                        id: newGeofenceId,
                        jobId: jobId,
                        latitude: geoLat,
                        longitude: geoLong,
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.directionsWrap}>
                        <Text style={styles.directions}>
                            To add an additional worksite for logging enter its address below, and adjust the circle to cover the area you want to track.
                        </Text>
                    </View>
